...
QUALIFICATION_MAPPING_RAW = {
    'sannolikhet': {
        ...
        'increasing': ['öka', 'ökar', 'ökad', 'ökande', 'stiger', 'stigande',
                       ...
                       'förstärkt', 'förstärkta', 'skärpt', 'skärpta', 'accelererar'],
        ...
        'stable': ['stabil', 'stabilt', 'stabila', 'oförändrad', 'oförändrat', 'oförändrade',
                   ...
                   'varaktig', 'varaktigt', 'varaktiga', 'ihållande',
                   'fortsatt', 'fortsatta', 'orubblig', 'orubbligt',
                   'jämn', 'jämnt', 'jämna', 'opåverkad', 'opåverkat', 'opåverkade',
                   'likvärdig', 'likvärdigt', 'likvärdiga', 'samma'],
    },
    'konsekvens': {
