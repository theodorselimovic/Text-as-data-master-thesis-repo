...
# Uses get_legacy_risk_dictionary() for backward compatibility with the old
# category structure (naturhot, biologiska_hot, etc.)
import sys
sys.path.insert(0, str(Path(__file__).parent.parent))
from dictionaries import get_legacy_risk_dictionary

RISK_DICTIONARY = get_legacy_risk_dictionary(include_extended=True)
